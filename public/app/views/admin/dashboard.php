        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="stats shadow">
                <div class="stat">
                    ...
                    <div class="stat-desc">Pedidos por procesar</div>
                </div>
            </div>
            ...
            <div class="stats shadow">
                <div class="stat">
                    ...
                    <div class="stat-title">Ticket Medio</div>
                    <div class="stat-value text-info">€<?= number_format($stats['average_order'] ?? 0, 2) ?></div>
                    <div class="stat-desc">Promedio por pedido</div>
                </div>
            </div>
        </div>
